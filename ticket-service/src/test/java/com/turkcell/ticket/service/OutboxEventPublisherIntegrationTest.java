...
class OutboxEventPublisherIntegrationTest {
    ...
    static PostgreSQLContainer<?> postgres = new PostgreSQLContainer<>("postgres:16")
            .withDatabaseName("ticket_db_test")
            .withUsername("test")
            .withPassword("test");
    ...
    static void configureProperties(DynamicPropertyRegistry registry) {
        ...
        registry.add("spring.cloud.stream.bindings.ticketEvents-out-0.destination", () -> "telco.ticket.events");
        registry.add("spring.cloud.stream.bindings.ticketEvents-out-0.content-type", () -> "application/json");
    }
    ...
    void setUpConsumer() {
        ...
        kafkaConsumer.subscribe(Collections.singletonList("telco.ticket.events"));
    }
    ...
    void publishesPendingOutboxEventToKafkaAndMarksPublished() {
        ...
        assertThat(record.value()).contains("\"eventType\":\"TicketOpened\"");
